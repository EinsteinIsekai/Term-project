...
public class Piece {
	...
	private final Point[][] pieces = {{mp(0, 4), mp(0, 5), mp(1, 4), mp(1, 5)}, //vuông
								 {mp(1, 3), mp(1, 4), mp(1, 5), mp(1, 6)},//cột 4
								 {mp(0, 3), mp(1, 3), mp(1, 4), mp(1, 5)},//L xoáy
								 {mp(0, 5), mp(1, 3), mp(1, 4), mp(1, 5)}, //L
								 {mp(1, 3), mp(1, 4), mp(0, 4), mp(0, 5)}, //cục ĐQX R
								 {mp(0, 3), mp(0, 4), mp(1, 4), mp(1, 5)},//cục ĐQX L
								 {mp(1, 3), mp(1, 4), mp(1, 5), mp(0, 4)}};//cục cộng thiếu 1 dấu
