...
public class Tetris  {
	// grid of color is that stores what kind of block is where
	 ...
	 * Magenta = T
	 */
	private static final Color[] c = {new Color(164,220,228), new Color(230,230,230), new Color(230,230,230), new Color(230,230,230),new Color(230,230,230), new Color(230,230,230), new Color(230,230,230), new Color(230,230,230), new Color(230,230,230)};
	private static final Color ghostColor = Color.DARK_GRAY;
//	private static final Image backgroundImage = new ImageIcon("D:/Minh Dũng/. VinUNI/2. Spring 2023/13. JAVA/Project/tetris-multiplayer-master/tetris-multiplayer-master/sources/Lovepik_com-400555125-gray-geometric-mobile-phone-wallpaper_hb.jpg/").getImage();
	private static final Color UIColor = new Color(204, 204,204);
	...
	public void displayUI (Graphics gi) {
		...
		//draw bảng điểm
		  // Tạo một đối tượng Font tùy chỉnh
        Font customFont = new Font("Cascadia Mono SemiLight", Font.BOLD, 10);

        // Thiết lập font cho đối tượng Graphics
        gi.setFont(customFont);
	...
	private int clearLines () {
		...
		while (true) {
			...
			musicPlayer.play("D:/Minh Dũng/1. VinUNI/2. Spring 2023/13. JAVA/Project/tetris-multiplayer-master/tetris-multiplayer-master/sources/phá cột.wav"
			);
	...
	protected void addGarbage (int lines) {
		...
		for (int i = 21; i >= Math.max(0, 22-lines); i--) {
			...
			PhatNhac musicPlayer = new PhatNhac();
			musicPlayer.play("D:/Minh Dũng/1. VinUNI/2. Spring 2023/13. JAVA/Project/tetris-multiplayer-master/tetris-multiplayer-master/sources/gửi rác.wav"
			);
